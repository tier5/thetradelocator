 ...
 */
function pmprowoo_tab_options_tab() { if (current_user_can('manage_options') ) {
    ?>
...
function pmprowoo_add_membership_discount() {
    ...
    <table>
        ...
        <tr>
            <th scope="row" valign="top"><label for="membership_discount"><?php _e("Membership Discount (%):", "pmpro-woocommerce"); ?></label></th>
            <td>
