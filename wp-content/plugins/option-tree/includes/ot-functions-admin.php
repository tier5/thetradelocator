...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    $array1 = array(
      array(
        'value'   => 'left-sidebar',
        'label'   => __( 'Left Sidebar', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => __( 'Right Sidebar', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => __( 'Full Width (no sidebar)', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/layout/full-width.png'
      )/*,
      array(
        'value'   => 'dual-sidebar',
        'label'   => __( 'Dual Sidebar', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/layout/dual-sidebar.png'
      ),
      array(
        'value'   => 'left-dual-sidebar',
        'label'   => __( 'Left Dual Sidebar', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/layout/left-dual-sidebar.png'
      ),
      array(
        'value'   => 'right-dual-sidebar',
        'label'   => __( 'Right Dual Sidebar', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/layout/right-dual-sidebar.png'
      )*/);
	$array2 = array(
      array(
        'value'   => 'one-column',
        'label'   => __( 'One Column', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/footer-layout/one-column.jpg'
      ),
      array(
        'value'   => 'two-columns',
        'label'   => __( 'Two Columns', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/footer-layout/two-columns.jpg'
      ),
      array(
        'value'   => 'three-columns',
        'label'   => __( 'Three Columns', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/footer-layout/three-columns.jpg'
      ),
      array(
        'value'   => 'four-columns',
        'label'   => __( 'Four Columns', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/footer-layout/four-columns.jpg'
      )
    );
  $array3 = array(
      array(
        'value'   => 'header1',
        'label'   => __( 'Header 1', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/header-1.png'
      ),
      array(
        'value'   => 'header2',
        'label'   => __( 'Header 2', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/header-2.png'
      ),
      array(
        'value'   => 'header3',
        'label'   => __( 'Header 3', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/header-2-2.png'
      )
    );
  $array4 = array(
      array(
        'value'   => 'header1',
        'label'   => __( 'Header 1', 'wyzi-business-finder' ),
        'src'     => OT_URL . 'assets/images/header-2-1.png'
      ),
      array(
        'value'   => 'header2',
        'label'   => __( 'Header 2', 'wyzi-business-finder' ),
	...
	if($field_id == 'footer-layout')
    return apply_filters( 'ot_radio_images', $array2 ,$field_id );
  elseif($field_id == 'sidebar-layout')
    return apply_filters( 'ot_radio_images', $array1 ,$field_id );
    elseif($field_id == 'shop-sidebar-layout')
       return apply_filters( 'ot_radio_images', $array1 ,$field_id );
  elseif($field_id == 'header-layout')
    return apply_filters( 'ot_radio_images', $array3 ,$field_id );

  elseif($field_id == 'header-layout2')
    return apply_filters( 'ot_radio_images', $array4 ,$field_id );
  }
