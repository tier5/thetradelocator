<div class="booked-settings-wrap wrap"><?php
	...
	if ( isset( $_GET['business-calendar'] ) && ! is_admin() ) {
		$post = get_post( $_GET['business-calendar'] );
		if ( null != $post && get_current_user_id() == $post->post_author ) {
			$calendar_ids = get_user_meta( get_current_user_id(), 'wyz_business_calendars', true );
			if ( isset( $calendar_ids[ $_GET['business-calendar'] ] ) )	{
				foreach ( $calendars as $cal ) {
					if ( $cal->term_id == $calendar_ids[ $_GET['business-calendar'] ] ) {
						$calendars = array( $cal );
						break;
					}
				}
	...
	if (!current_user_can('manage_booked_options') && $booked_none_assigned):
		...
		<div class="topSavingState savingState"><i class="fa fa-refresh fa-spin"></i>&nbsp;&nbsp;<?php esc_html_e('Updating, please wait...','wyzi-business-finder'); ?></div>
		...
		<div id="booked-admin-panel-container">
			...
			<?php $booked_settings_tabs = apply_filters('booked_settings_tabs', array(
				array(
					'access' => 'admin',
					'slug' => 'general',
					'content' => '<i class="fa fa-gear"></i>&nbsp;&nbsp;'.esc_html__('General','wyzi-business-finder')),
				array(
					'access' => 'admin',
					'slug' => 'email-settings',
					'content' => '<i class="fa fa-envelope"></i>&nbsp;&nbsp;'.esc_html__('Emails','wyzi-business-finder')),
				array(
					'access' => 'agent',
					'slug' => 'defaults',
					'content' => '<i class="fa fa-clock-o"></i>&nbsp;&nbsp;'.esc_html__('Time Slots','wyzi-business-finder').'<span class="savingState">&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh fa-spin"></i></span>'),
				array(
					'access' => 'agent',
					'slug' => 'custom-timeslots',
					'content' => '<i class="fa fa-clock-o"></i>&nbsp;&nbsp;'.esc_html__('Custom Time Slots','wyzi-business-finder').'<span class="savingState">&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh fa-spin"></i></span>'),
				array(
					'access' => 'agent',
					'slug' => 'custom-fields',
					'content' => '<i class="fa fa-pencil"></i>&nbsp;&nbsp;'.esc_html__('Custom Fields','wyzi-business-finder')),
				array(
					'access' => 'admin',
					'slug' => 'export-appointments',
					'content' => '<i class="fa fa-external-link-square"></i>&nbsp;&nbsp;'.esc_html__('Export','wyzi-business-finder')),
				array(
					'access' => 'admin',
					'slug' => 'shortcodes',
					'content' => '<i class="fa fa-code"></i>&nbsp;&nbsp;'.esc_html__('Shortcodes','wyzi-business-finder')),
			));
										...
										<div id="booked-subtab-email-settings" class="subtab-content">
											...
											<div class="section-row">
												<div class="section-head">
													...
													<?php $section_title = esc_html__('Having Email Issues?', 'wyzi-business-finder'); ?>
													<h3><?php echo esc_attr($section_title); ?></h3>
				
													<p><strong style="display:block; margin:0 0 5px; font-size:14px;"><?php esc_html_e('No emails sending at all:','wyzi-business-finder'); ?></strong>
													<?php echo sprintf( esc_html__('If no emails are being sent at all, trying using an SMTP plugin: %s','wyzi-business-finder'), '<a href="https://wordpress.org/plugins/wp-mail-smtp/" target="_blank">https://wordpress.org/plugins/wp-mail-smtp/</a>' ); ?></p>

													<p><strong style="display:block; margin:0 0 5px; font-size:14px;"><?php esc_html_e('Emails not sending to admins/agents:','wyzi-business-finder'); ?></strong>
													...
													<p style="margin:1.2em 0 15px;">
														<input style="margin:-4px 5px 0 0;" id="booked_email_force_sender" name="booked_email_force_sender" value="true"<?php if ($selected_value): echo ' checked="checked"'; endif; ?> type="checkbox">
														<label class="checkbox-radio-label" for="booked_email_force_sender"><strong><?php esc_html_e("Force sender name/email", "booked"); ?></strong></label>
													</p>
								...
								<div id="booked-custom-timeslots" class="tab-content">
									...
									<form action="" id="customTimeslots">
															...
															if (!empty($timeslots)):
																...
																foreach ($timeslots as $timeslot => $count):
																	...
																	echo '<span class="timeslot" data-timeslot="'.$timeslot.'">';
																		echo '<span class="slotsBlock"><span class="changeCount minus" data-count="-1"><i class="fa fa-minus-circle"></i></span><span class="count"><em>'.$count.'</em> ' . _n('Space Available','Spaces Available',$count,'wyzi-business-finder') . '</span><span class="changeCount add" data-count="1"><i class="fa fa-plus-circle"></i></span></span>';
																		...
																		if ($time[0] == '0000' && $time[1] == '2400'):
																			echo '<span class="start"><i class="fa fa-clock-o"></i>&nbsp;&nbsp;' . strtoupper(esc_html__('All day','wyzi-business-finder')) . '</span>';
																		else :
										...
										<div class="section-row submit-section bookedClearFix" style="padding:0;">
											<button class="button addCustomTimeslot"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php esc_html_e('Add Date(s)','wyzi-business-finder'); ?></button>
											...
											<div class="cts-updater savingState"><i class="fa fa-refresh fa-spin"></i>&nbsp;&nbsp;<?php esc_html_e('Saving','wyzi-business-finder'); ?>...</div>
										</div><!-- /.section-row -->
							...
							case 'custom-fields': ?>
								...
								<div id="booked-custom-fields" class="tab-content">
										...
										<div class="section-head">
											...
											<ul id="booked-cf-sortable-templates">
												...
												<li id="bookedCFTemplate-checkboxes-label" class="ui-state-default"><i class="main-handle fa fa-bars"></i>
													...
													<button class="cfButton button" data-type="single-checkbox"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php esc_html_e('Checkbox','wyzi-business-finder'); ?></button>
													<span class="cf-delete"><i class="fa fa-close"></i></span>
												</li>
												<li id="bookedCFTemplate-radio-buttons-label" class="ui-state-default"><i class="main-handle fa fa-bars"></i>
													...
													<button class="cfButton button" data-type="single-radio-button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php esc_html_e('Radio Button','wyzi-business-finder'); ?></button>
													<span class="cf-delete"><i class="fa fa-close"></i></span>
												</li>
												<li id="bookedCFTemplate-drop-down-label" class="ui-state-default"><i class="main-handle fa fa-bars"></i>
													...
													<button class="cfButton button" data-type="single-drop-down"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php esc_html_e('Option','wyzi-business-finder'); ?></button>
													<span class="cf-delete"><i class="fa fa-close"></i></span>
												</li>
									...
									<div class="section-row submit-section bookedClearFix" style="padding:0;">
										...
										<div class="cf-updater savingState"><i class="fa fa-refresh fa-spin"></i>&nbsp;&nbsp;<?php esc_html_e('Saving','wyzi-business-finder'); ?>...</div>
									</div><!-- /.section-row -->
							...
							case 'export-appointments': ?>
								...
								<form action="" class="booked-export-form" method="post">
									...
									<div id="booked-export-appointments" class="tab-content">
										...
										<div class="section-row submit-section" style="padding:0;">
											<p class="submit">
												<button class="button-primary"><i class="fa fa-external-link-square"></i>&nbsp;&nbsp;<?php esc_html_e('Export Appointments to CSV','wyzi-business-finder'); ?></button>
											</p>
										</div>
