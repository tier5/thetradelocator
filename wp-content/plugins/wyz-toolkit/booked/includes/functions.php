	...
	echo '<div class="booked-appt-list" data-list-date="'.$date.'" data-min-date="'.($prevent_before ? date_i18n('Y-m-d',strtotime($prevent_before)) : $earliest_date).'" data-max-date="'.($prevent_after ? date_i18n('Y-m-d',strtotime($prevent_after)) : false).'">';
		...
		*/
		...
		echo '<div class="booked-list-view-nav" data-calendar-id="'.$calendar_id.'">';
			if ($showing_prev):
				echo '<button data-date="'.date_i18n('Y-m-d',strtotime($prev_day)).'" class="booked-list-view-date-prev bb-small"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;'.esc_html__('Previous','wyzi-business-finder').'</button>';
			endif;
			if ($showing_next):
				echo '<button data-date="'.date_i18n('Y-m-d',strtotime($next_day)).'" class="booked-list-view-date-next bb-small">'.esc_html__('Next','wyzi-business-finder').'&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>';
			endif;
...
function booked_profile_content_edit(){
	...
	echo '<h4><i class="fa fa-edit"></i>&nbsp;&nbsp;'.esc_html__('Edit Profile','wyzi-business-finder').'</h4>'; ?>
