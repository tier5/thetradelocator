				...
				echo '<div class="booked-profile-appt-list">';
					...
					foreach($appointments_array as $appt):
						...
						echo '<span class="appt-block bookedClearFix '.(!$historic ? $status_class : 'approved').'" data-appt-id="'.$appt['post_id'].'">';
							...
							echo (!empty($appt['calendar_id']) ? '<i class="fa fa-calendar-o"></i><strong>'.esc_html__('Calendar','wyzi-business-finder').':</strong> '.$appt['calendar_id'][0]->name.'<br>' : '');
							...
							echo ($cf_meta_value ? '<br><i class="fa fa-info-circle"></i><a href="#" class="booked-show-cf">'.esc_html__('Additional information','wyzi-business-finder').'</a><div class="cf-meta-values-hidden">'.$cf_meta_value.'</div>' : '');
			...
			?><div id="booked-profile-page">
				...
				<div id="booked-page-form">
					...
					<ul class="booked-tabs login bookedClearFix">
						<li<?php if ( !isset($_POST['booked_reg_submit'] ) ) { ?> class="active"<?php } ?>><a href="#login"><i class="fa fa-lock"></i><?php esc_html_e('Sign In','wyzi-business-finder'); ?></a></li>
						<?php if (get_option('users_can_register')): ?><li<?php if ( isset($_POST['booked_reg_submit'] ) ) { ?> class="active"<?php } ?>><a href="#register"><i class="fa fa-pencil"></i><?php esc_html_e('Register','wyzi-business-finder'); ?></a></li><?php endif; ?>
						<li><a href="#forgot"><i class="fa fa-life-ring"></i><?php esc_html_e('Forgot Password','wyzi-business-finder'); ?></a></li>
					</ul>
					...
					<div id="profile-login" class="booked-tab-content">
						...
						<div class="booked-form-wrap bookedClearFix">
							...
							<?php echo wp_login_form( array( 'echo' => false, 'redirect' => get_the_permalink($login_redirect), 'label_username' => esc_html__( 'Email or Username','wyzi-business-finder' ) ) ); ?>
						</div>
					</div>
