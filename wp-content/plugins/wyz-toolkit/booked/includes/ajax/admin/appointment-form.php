...
<div class="booked-scrollable">
	...
	<form action="" method="post" class="booked-form" id="newAppointmentForm"<?php if ($calendar_id): echo ' data-calendar-id="'.$calendar_id.'"'; endif; ?>>
		...
		<div class="field">
			<input data-condition="customer_type" type="radio" name="customer_type" id="customer_current" value="current" checked> <label for="customer_current"><?php esc_html_e('Current Customer','wyzi-business-finder'); ?></label>
		</div>
		<div class="field">
			<input data-condition="customer_type" type="radio" name="customer_type" id="customer_new" value="new"> <label for="customer_new"><?php esc_html_e('New Customer','wyzi-business-finder'); ?></label>
		</div>
		
		<?php if ($guest_booking): ?>
			<div class="field">
				<input data-condition="customer_type" type="radio" name="customer_type" id="customer_guest" value="guest"> <label for="customer_guest"><?php esc_html_e('Guest','wyzi-business-finder'); ?></label>
			</div>
		<?php endif; ?>
		...
		<div class="condition-block customer_type default" id="condition-current" data-condition-val="current">
			<div class="field">
				<select data-placeholder="<?php esc_html_e('Select a customer','wyzi-business-finder'); ?>..." id="userList" name="user_id">
					<option></option>
		...
		<div class="condition-block customer_type" id="condition-new" data-condition-val="new">
			...
			<?php if (isset($name_requirements[0]) && $name_requirements[0] == 'require_surname'): ?>
				<div class="field">
					<input value="" placeholder="<?php esc_html_e('First Name','wyzi-business-finder'); ?>..." type="text" class="textfield" name="name" />
					<input value="" placeholder="<?php esc_html_e('Last Name','wyzi-business-finder'); ?>..." type="text" class="textfield" name="surname" />
				</div>
			<?php else: ?>
				<div class="field">
					<input value="" placeholder="<?php esc_html_e('Name','wyzi-business-finder'); ?>..." type="text" class="large textfield" name="name" />
				</div>
			<?php endif; ?>

			<div class="field">
				<input value="" placeholder="<?php esc_html_e('Email Address','wyzi-business-finder'); ?>..." type="email" class="textfield" name="email" />
				<input value="" placeholder="<?php esc_html_e('Choose a password','wyzi-business-finder'); ?>..." type="password" class="textfield" name="password" />
			</div>
		</div>
		...
		<div class="field">
			<input type="submit" class="button button-primary" value="<?php esc_html_e('Create Appointment','wyzi-business-finder'); ?>">
			<button class="cancel button"><?php esc_html_e('Cancel','wyzi-business-finder'); ?></button>
		</div>

	</form>
</div>

<p class="booked-title-bar"><small><?php esc_html_e('New Appointment','wyzi-business-finder'); ?></small></p>
