...
<div class="bookings">
	...
	if ( ! $total_calendars ) {
		esc_html_e( 'Sorry, there are no bookings available', 'wyzi-business-finder' );
	}
	?>
		...
		<div class="booked-tabs">
			<div class="booked-tabs-nav">
				<?php $i = 0; foreach ( $bookings as $calendar_id => $appointments ): ?>
					<?php
					$calendar_title = esc_html__('Unknown', 'wyzi-business-finder');

					if ( ! $calendar_id ) {
						$calendar_title = esc_html__('Default', 'wyzi-business-finder');
					}
