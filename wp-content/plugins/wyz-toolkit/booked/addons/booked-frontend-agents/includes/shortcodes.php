				...
				echo '<div class="booked-fea-appt-list">';
					...
					foreach($appointments_array as $appt):
						...
						echo '<div class="appt-block bookedClearFix" data-appt-id="'.$appt['post_id'].'">';
							...
							echo ($cf_meta_value ? '<br><i class="fa fa-info-circle"></i><a href="#" class="booked-show-cf">'.__('Additional information','wyzi-business-finder').'</a><div class="cf-meta-values-hidden">'.$cf_meta_value.'</div>' : '');
