...
jQuery(document).ready(function() {
    ...
    */
    ...
    if(fieldsettest.is(':last-child')){
        jQuery('.blue-btn-square.button-primary').fadeIn('fast');
    }
    // next step
    ...
    jQuery('#wyz_frontend_businesses .btn-previous').on('click', function() {
    	...
    	if(jQuery('.blue-btn-square.button-primary').is(':visible'))
			jQuery('.blue-btn-square.button-primary').fadeOut('fast');
    });
