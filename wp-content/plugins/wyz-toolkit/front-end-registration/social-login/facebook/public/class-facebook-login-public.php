...
class WYZFacebook_Login_Public {
	...
	public function print_button() {
		...
		switch ( $template_type) {
			case 1:
				echo apply_filters('fbl/login_button', '<a href="#" class="wyz-button blue icon social-login facebook  js-fbl" data-redirect="'.apply_filters( 'flp/redirect_url', $redirect).'" data-fb_nonce="' . wp_create_nonce( 'facebook-nonce' ).'"><i class="fa fa-facebook"></i>' . esc_html__( 'Sign In with facebook', 'wyzi-business-finder' ) . '</a>');
				break;
			case 2:
