...
class Wyz_Offers_Tabs_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( is_singular( 'wyz_business' ) ) {
			$output .= '<li class="active"><a href="#related-offers" data-toggle="tab">' . esc_html__( 'related', 'wyzi-business-finder') . '</a></li>';
			$output .= '<li><a href="#recent-offers" data-toggle="tab">' . esc_html__( 'recent', 'wyzi-business-finder') . '</a></li></ul>';
		} else {
			$output .= '<li class="active single"><a href="#recent-offers" data-toggle="tab">' . esc_html__( 'recent', 'wyzi-business-finder') . '</a></li></ul>';
		}
		...
		if ( is_singular( 'wyz_business' ) ) {
			...
			if ( isset( $queried_business->ID ) ) {
				...
				$output .= '<div class="tab-pane active" id="related-offers">';
				$related_args = array(
					'posts_per_page' => -1,
		...
		$output .= '<div class="tab-pane' . ( is_singular( 'wyz_business') ? '' : ' active' ) . '" id="recent-offers">';
