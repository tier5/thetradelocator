...
if ( ! defined( 'ABSPATH' ) ) exit;
	...
	if(isset($_POST['submit']))
	{
		if(!ns_save_product()){			//error found, return empty html;
			...
			echo '<div class="wyz-info"><p>' . esc_html__('Your product has been added.','wyzi-business-finder') . '</p></div>';
			} else {
			echo '<div class="wyz-info"><p>' .  esc_html__('Your product has been submitted for review.','wyzi-business-finder') . '</p></div>';
			}
		}
	}
...
?>
		...
		<button type="submit" id="new-product-save" class="blue-btn-square" name="submit"><?php echo esc_html__('Save','wyzi-business-finder')?></button>			
</div>
