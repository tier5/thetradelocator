...
class WyzBusinessRating{
	...
	private static function the_rating_wall( $post_id ) {
		...
		<div class="sin-busi-rate animated  fadeInDown">
			<!-- Post Head -->
			<div class="head fix">
	...
	private static function the_rate_author( $post_id, $type = 1 ) {
		...
		echo $type == 1 ? sprintf( __( 'by <span class="auth">%s</span>', 'wyzi-business-finder' ), $author_name ) : $author_name ;
	}
