...
if ( isset( $contact_info_missing ) && true === $contact_info_missing ) {
	echo'<div class="wyz-error"><p>' . esc_html__( 'Security Violation Error', 'wyzi-business-finder' ) . '</p></div>';
	...
	echo '<div class="wyz-success"><p>' . esc_html__( 'Email sent succesfully', 'wyzi-business-finder' ) . '</p></div>';
} ?>
	...
	<form method="post" class="wyz-form contact-form">
		...
		<input type="submit" name="submit" id="submit" value="<?php esc_html_e( 'send message', 'wyzi-business-finder' );?>" />
	</form>
</div>
