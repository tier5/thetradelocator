			...
			<div class="create-busi-post edit-busi-post">
				...
				<form id="business-post-edit-form" class="create-busi-post-form">
					...
					<div class="form-footer fix">
							...
							<input type="button" id="busi_edit_post_submit" class="busi_post_submit action-btn btn-bg-grey btn-hover-blue" value="<?php esc_html_e('Update', 'wyzi-business-finder');?>" />
