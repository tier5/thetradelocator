<div id="create-busi-rate" class="create-busi-post">
	...
	<form id="business-rate-form" class="create-busi-post-form">
		...
		<div class="form-footer fix">
			...
			<input type="button" id="busi_rate_submit" class="busi_post_submit float-right action-btn btn-bg-grey btn-hover-blue" value="<?php esc_html_e( 'Rate', 'wyzi-business-finder' );?>" />
